   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%      screen params  max(Screen('Screens'))
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
screenVar = struct('num', {0}, 'rectPix',{[0 0 1920 1080]}, 'dist', {38}, 'size', {[52.5 29.5]},...
...
%      stimuli params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
stim = struct('dur', {.65}, 'possibleAngels', {[345 15]},'boundaryAngle', {[0 0 ]},...
    'radiusDeg',{9}, 'bkColor', {gray}, 'speedDegPerSec', {15},'lifetime', {1}, 'limitLifetime', {0.05});
% [3 357 183 177]
...
%      Dot params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
dots = struct( 'color',{black},'sizeInPix', {6});
numdotsperdeg = 1.65;
...
%            boundary params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
boundary = struct( 'color',{[black black black 255]},'penWidthPix', {2}, 'present',{1}, 'lengthDeg', {1}); 
...
%      Trial params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
trialVars = struct('numTrialsPerBlock', {18}); 
...
%     instructions params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
instruct = struct('text',{'Please indicate if the overall motion direction of the dots was up or down from the boundary'}); 
