...
%      screen params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
screenVar = struct('guess', {0}, 'num', {0}, 'rectPix',{[0 0 1920 1080 ]}, 'dist', {52}, 'size', {[29 51 ]},...
                    'res', {[  1080 1920]},'calib_filename', {'gammaTable.mat'}, 'monRefresh', {60}); %display size in mm
...
fixationVar = struct( 'color',{[black black black 255]},'dur', {0.5}, 'penWidthPix', {3}, 'bkColor', screenVar.bkColor,...
...
%            Gabor params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
gabor= struct('numStim', {2}, 'StimXDeg',{4}, 'StimYDeg', {4}, 'StimEccDeg', {5}, 'dur', {0.07}, 'SF', {4}, 'preStimDur', {0.04}, 'postStimDur', {0.3}, ...
    'polarAng', {0}, 'GaussSD', 3, 'bkColor', {screenVar.bkColor},'possibleAngels', {[5 355]}, 'cw_ccw',  {[1 2 ]}, 'boundaryAngle', {90}); 
...
%      Stair params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
stair = struct( 'runType',{1},'numStaircases', {1}, 'numDownStep',{[2]},...
                'maxThresh', {-0.01}, 'minThresh', {-2},'minStepsize', {0.003},...
                'startStepsize', {[.4] },'startValues', {[-0.2]});
...
stair.nonStairCoh = [-0.3]; %log contrast (if you want to show 0.3 put here -0.5 --- 10^-0.5=0.3
%a = linspace(-2,0, 15)
 %plot(a,10.^a, '.')
...
responseVar.cw_ccw = [2 1]; %first is CW up, 3 down
...
%      Save Data params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
saveVars = struct('fileName', {'2gabors_'}, 'expTypeDirName', {'2gabors_contrast_'});
...
%     ISI params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ISIVar = struct('preDur',{1}, 'postDur', {0.3}); 
