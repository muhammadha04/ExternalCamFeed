...
%      screen params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
screenVar = struct('guess', {0}, 'num', {0}, 'rectPix',{[0 0 1100 2300]}, 'dist', {40}, 'size', {[22.2 34.4 ]},...
                    'res', {[ 2234 3440 ]},, 0); %display size in mm
oldResolution=Screen('Resolution', 0) 'calib_filename', {'gammaTable_sarit.mat'}, 'monRefresh', {60}); 
...
%                     'res', {[2234 3440]}, 'calib_filename', {'gammaTable_sarit.mat'}, 'monRefresh', {120}); 
% 
...
fixationVar = struct( 'color',{[black black black 255]},'dur', {0.5}, 'penWidthPix', {5}, 'bkColor', screenVar.bkColor,...
...
%            Gabor params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
gabor= struct('numStim', {1}, 'StimXDeg',{2}, 'StimYDeg', {2}, 'StimEccDeg', {5}, 'dur', {0.3}, 'SF', {4}, 'preStimDur', {0.04}, 'postStimDur', {0.3}, ...
    'polarAng', {0}, 'GaussSD', 3, 'bkColor', {screenVar.bkColor},'possibleAngels', {[80 100]}, 'cw_ccw',  {[1 2 ]}, 'boundaryAngle', {90}); 
...
preCue = struct('type', {0}, 'dur', {0.04}); 


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%      Exogenous precue params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
preCueExg = struct('radiusDeg', {0.4}, 'color',{black}, 'bkColor', {screenVar.bkColor}, ...
...
preCueExg.rectPix1 = CenterRectOnPoint([0 0 sp1 sp1], screenVar.centerPix(2)-gabor.StimEccPix,screenVar.centerPix(1)-preCueExg.dist2stimPix);
preCueExg.rectPix2 = CenterRectOnPoint([0 0 sp1 sp1], screenVar.centerPix(2)+gabor.StimEccPix,screenVar.centerPix(1)-preCueExg.dist2stimPix);


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%      Neutral precue params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
neutralCue = struct('radiusDeg', {0.8}, 'color',{black}, ...
                   'dur', {0.5}, 'dist2centerDeg', {2}); 
...
% 
neutralCue.rectPix1 = CenterRectOnPoint([0 0 sp1 sp1], screenVar.centerPix(2),screenVar.centerPix(1)-neutralCue.dist2centerPix);
...
%     post cue params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
postCue = struct('color',{black},'bkColor', {screenVar.bkColor}, 'dur', {1}, 'penWidthPix', {10},...
...
postCue.rectPix1 = [screenVar.centerPix(2)-postCue.postCueStartDegPix, screenVar.centerPix(1), screenVar.centerPix(2)-postCue.centerXdistPix,screenVar.centerPix(1)];
postCue.rectPix2 = [screenVar.centerPix(2)+postCue.postCueStartDegPix, screenVar.centerPix(1), screenVar.centerPix(2)+postCue.centerXdistPix,screenVar.centerPix(1)];
...
%      Stair params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
stair = struct( 'runType',{1},'numStaircases', {3}, 'numDownStep',{[2 2 2]},...
                'maxThresh', {-0.01}, 'minThresh', {-2},'minStepsize', {0.003},...
                'startStepsize', {[.4 .4 .4] },'startValues', {[-0.2 -0.39 -0.1]});
...
stair.nonStairCoh = [-0.2]; %log contrast (if you want to show 0.3 put here -0.5 --- 10^-0.5=0.3
%a = linspace(-2,0, 15)
 %plot(a,10.^a, '.')
...
responseVar = struct( 'allowedRespKeys', {['s', 'a']}, 'dur',{5},'keyEscape', 'ESCAPE', 'percentEstimation', {0});
...
%      Save Data params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
saveVars = struct('fileName', {'motionExp_pilot_disc_'}, 'expTypeDirName', {'EstiDisc'});
...
%     ISI params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ISIVar = struct('preDur',{1}, 'postDur', {1}); 
