...
gabor= struct('numStim', {2}, 'StimXDeg',{2}, 'StimYDeg', {2}, 'StimEccDeg', {5}, 'dur', {0.5}, 'SF', {4}, 'preStimDur', {0.04}, 'postStimDur', {0.3}, ...
    'polarAng', {0}, 'GaussSD', 3, 'bkColor', {screenVar.bkColor},'possibleAngels', {[50 30]}, 'cw_ccw',  {[2 1]}, 'boundaryAngle', {90}); 
...
stair.nonStairCoh = [0.6]; %log contrast (if you want to show 0.3 put here -0.5 --- 10^-0.5=0.3
%a = linspace(-2,0, 15)
 %plot(a,10.^a, '.')
