...
%            Gabor params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
gabor= struct('numStim', {2}, 'StimXDeg',{2}, 'StimYDeg', {2}, 'StimEccDeg', {5}, 'dur', {0.1}, 'SF', {4}, 'preStimDur', {0.04}, 'postStimDur', {0.3}, ...
    'polarAng', {0}, 'GaussSD', 3, 'bkColor', {screenVar.bkColor},'possibleAngels', {[50 30]}, 'cw_ccw',  {[1 2 ]}, 'boundaryAngle', {90}); 
...
%      Save Data params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
saveVars = struct('fileName', {'_oblique_2gabors_'}, 'expTypeDirName', {'2gabors_contrast_'});
