...
%      stimuli params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
stim = struct('dur', {.75}, 'possibleAngels', {[310 330]},'boundaryAngle', {[320 320]},...
...
responseVar = struct( 'allowedRespKeys', {['6', '3']}, 'dur',{0.5},'keyEscape', 'ESCAPE', 'percentEstimation', {0});
...
%      Trial params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
trialVars = struct('numTrialsPerBlock', {2}); 
