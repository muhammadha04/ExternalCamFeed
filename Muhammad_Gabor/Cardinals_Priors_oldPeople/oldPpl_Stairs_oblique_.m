...
%      screen params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
screenVar = struct('num', {max(Screen('Screens'))}, 'rectPix',{[0 0 1920 1080]}, 'dist', {38}, 'size', {[34 19]},...
...
%      stimuli params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
stim = struct('dur', {.3  }, 'possibleAngels', {[310 330]},'boundaryAngle', {[320 320]},...
...
responseVar = struct( 'allowedRespKeys', {['6', '3']}, 'dur',{30},'keyEscape', 'ESCAPE', 'percentEstimation', {0});
...
%      Trial params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
trialVars = struct('numTrialsPerBlock', {120}); 
...
%      Save Data params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
saveVars = struct('fileName', {'kidsMotion_testing_disc_oblique_Staircase_'}, 'expTypeDirName', {'Revised_Exp'});
