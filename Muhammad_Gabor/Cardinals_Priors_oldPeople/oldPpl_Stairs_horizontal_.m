...
%      stimuli params 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
stim = struct('dur', {.3  }, 'possibleAngels', {[350 10]},'boundaryAngle', {[0 0]},...
...
%      Save Data params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
saveVars = struct('fileName', {'kidsMotion_testing_disc_horizontal_Staircase_'}, 'expTypeDirName', {'Revised_Exp'});
